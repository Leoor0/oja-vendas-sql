...
--  Modelo baseado no padrão Venda + Itens da Venda
--  Dialeto: MySQL 8.x (compatível com MySQL Workbench)
-- =============================================
...
CREATE TABLE produto (
  ...
  tipo        VARCHAR(10) NOT NULL CHECK (tipo IN ('CAMISA','CALCA','VESTIDO')),
